...
;(function(root, factory) {
    ...
    FormValidator.prototype = {
        ...
        texts : {
            ...
            no_match        : 'Tidak Sesuai',
            complete        : 'input belum sesuai ketentuan'
        },
        ...
        mark : function( field, text ){
            ...
            if( this.settings.alerts ){
                if( alert )
                    ...
                    warning = '<div class="col-md-offset-5 col-md-7 alert '+ this.settings.classes.alert +'">' + text + '</div>';
